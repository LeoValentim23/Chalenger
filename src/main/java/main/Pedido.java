...
public class Pedido {
    ...
    public static void main(String[] args) {
        ...
        //se os  tres apresentarem  Guincho.Guincho aprovado , ele esta sendo liberado para utiliar o chamado

        System.out.println("Guincho_pesado_não_padrão");
        if (peso > 10 && Guincho_pesado_não_padrão) {
            System.out.println("Guincho.Guincho aprovado.");
        }  else {
            System.out.println("Guincho.Guincho NÃO aprovado.");
        }
